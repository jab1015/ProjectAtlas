...
describe("inventor evidence ingestion", () => {
  ...
  it("lets an authorized collaborator safely retry failed binary extraction without re-uploading the evidence", () => {
    ...
    expect(controlSource).toContain("requireInventionEditAccess");
    expect(controlSource).not.toContain("getAuthUserId");
