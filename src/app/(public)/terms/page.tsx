const sections = [
  ...
  ["Inventor ownership and responsibility", "As between you and InventSmith, you retain rights you hold in the invention information you submit. You authorize InventSmith to process that information to provide requested services. You are responsible for having submission rights, protecting secrecy before disclosure, evaluating outputs, making decisions, and obtaining required professional approvals, tests, permits, insurance, and filings."],
  ...
  ["Pilot availability and termination", "The controlled pilot may change, pause, or discontinue features. InventSmith may suspend access for security, abuse, nonpayment, or excluded-risk use. You may stop using the service and request account deletion, subject to transaction, security, dispute, and legal retention requirements."],
...
export default function TermsPage() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
      ...
      <p className="mt-4 text-sm leading-relaxed text-muted-foreground">Effective August 15, 2026. These terms reflect InventSmith's current safety and autonomy boundaries but are not approved for public launch.</p>
