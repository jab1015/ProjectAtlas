...
export default function TermsPage() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
      ...
      <h1 className="mt-3 text-4xl font-bold tracking-tight">InventSmith Terms of Service</h1>
      <p className="mt-4 text-sm leading-relaxed text-muted-foreground">Effective August 14, 2026. These terms reflect InventSmith&rsquo;s current safety and autonomy boundaries. InventSmith is a Modern Methods product. These terms are not approved for public launch.</p>
