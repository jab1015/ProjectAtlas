        ...
        <div className="mx-auto max-w-4xl space-y-10 px-4 py-10 sm:px-6 sm:py-14">
          <header className="space-y-5">
            ...
            <p className="max-w-2xl text-base leading-relaxed text-muted-foreground">
              InventSmith is organizing the work around your invention. Review what changed, provide input when needed, and let InventSmith keep moving the work forward.
            </p>
          </header>
