...
const cadSpecSchema = {
  ...
  properties: {
    ...
    parts: { type: "array", minItems: 1, maxItems: 24, items: { type: "object", additionalProperties: false, properties: {
      id: { type: "string" }, name: { type: "string" }, material: { type: "string" }, finish: { type: "string" }, manufacturingProcess: { type: "string" }, interfaceNotes: { type: "array", items: { type: "string" } }, primitiveType: { type: "string", enum: ["box", "cylinder", "tube", "frustum", "threadedCylinder", "threadedTube", "extrudedConvexPolygon"] },
...
interface ModelPart {
  ...
  primitiveType: "box" | "cylinder" | "tube" | "frustum" | "threadedCylinder" | "threadedTube" | "extrudedConvexPolygon";
  sizeX: number;
  sizeY: number;
  sizeZ: number;
  radius: number;
