...
export const FULL_JOURNEY_STAGES: FullJourneyStageDefinition[] = [
  ...
  { id: 6, name: "Prototype", routeType: "department", requiredWorkKinds: ["prototype_strategy", "prototype_sourcing_plan", "prototype_test_plan", "prototype_physical_evidence", "prototype_evidence_assessment", "prototype_design_gap_analysis", "prototype_readiness"], dependsOnStageIds: [5] },
  { id: 7, name: "Manufacturing", routeType: "department", requiredWorkKinds: ["manufacturing_process_plan", "factory_requirements", "manufacturer_sourcing", "manufacturer_rfq_package", "manufacturer_scorecard", "manufacturing_unit_economics", "manufacturer_quote_evidence", "manufacturer_quote_comparison", "manufacturing_agreement_checklist", "manufacturing_readiness"], dependsOnStageIds: [5, 6] },
