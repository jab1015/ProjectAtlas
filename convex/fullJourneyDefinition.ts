...
export const FULL_JOURNEY_STAGES: FullJourneyStageDefinition[] = [
  ...
  { id: 4, name: "Patent Readiness", routeType: "foundation", requiredWorkKinds: ["preliminary_prior_art", "feature_prior_art_comparison", "distinguishing_features", "ip_readiness"], dependsOnStageIds: [1, 2, 3] },
  ...
  { id: 9, name: "Intellectual Property / Legal", routeType: "department", requiredWorkKinds: ["ip_strategy_plan", "invention_disclosure_package", "nda_draft_package", "contracting_package", "ip_status_tracker", "professional_legal_handoff"], dependsOnStageIds: [4, 5] },
