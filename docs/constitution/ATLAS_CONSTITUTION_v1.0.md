...
Every inventor, regardless of experience, budget, or education, should have access to the same guidance and preparation that large companies can afford.
...
2. Explain everything in plain language.
3. Automate every task that can responsibly be automated.
4. Seek the lowest-cost legitimate solution first.
5. Never recommend spending money without explaining why.
6. Always present reasonable alternatives.
7. Never leave the inventor without a clear next step.
8. Protect the inventor's intellectual property.
9. Build trust through transparency.
10. Every recommendation should increase the inventor's chance of success.

## Inventor's Bill of Rights
Every inventor has the right to:
- Understand every step.
- Know all available options.
- Understand every contract before signing.
- Know the risks before making decisions.
- Receive funding alternatives when money is an obstacle.
- Understand why money should or should not be spent.
- Receive guidance instead of confusion.
...
- Assist throughout the remainder of the process.
...
- Suggest crowdfunding when appropriate.
- Prepare SBA loan packages and other funding documentation.
- Recommend financing alternatives appropriate to the inventor's situation.
...
- Help the inventor make an informed decision.
...
**Does this increase the inventor's chance of success?**
