...
- Engage a qualified IP attorney as an informed, prepared client — not as a first-time buyer without context
- Initiate the appropriate patent filing for the invention: provisional, utility, or design
- File a trademark application for the brand name established in Stage 8
- Document trade secrets and ensure appropriate NDAs are in place with all third parties
- Establish an IP Status Tracker that remains accurate through all remaining stages
...
- NDA coverage for all third parties with access to confidential information

---

## Inputs

- Patent Readiness Report from Stage 4 (prior art summary, novel element statements, IP strategy recommendation)
- Brand Identity System from Stage 8 (brand name and any logo elements, for trademark registration)
- Product Design Specification from Stage 5 (for design patent consideration if applicable)
- The inventor's IP budget and timeline preferences
- A list of all third parties who have had access to the invention (manufacturers, contractors, advisors, investors)
- Any existing IP filings the inventor has initiated
...
- IP Brief drafting — organizing all prior art research, novel elements, and IP strategy context into an attorney-ready document
- Patent type selection guidance — explaining the trade-offs between provisional, utility, and design patents for the specific invention
- Trademark search guidance — USPTO TESS search methodology and International Class identification
- Trademark application preparation — organizing all information needed for the attorney to file
- Trade secret identification — analyzing the invention's context to identify what qualifies for trade secret protection
- NDA template preparation customized to the inventor's situation
- IP Filing Checklist generation — all pre-filing tasks with responsible parties and deadlines
- IP Status Tracker initialization and maintenance
- Key deadline tracking — provisional-to-utility conversion window and other critical dates

---

## Outputs

- **IP Brief** — a structured, attorney-ready document summarizing the invention, prior art findings, novel elements, and IP strategy intentions
- **IP Filing Checklist** — all pre-filing tasks in order, with responsible party (inventor vs. attorney) and deadline for each
- **Trade Secret Documentation Template** — the structured format for documenting confidential information as formal trade secrets
- **NDA Template** — a standard non-disclosure agreement customized to the inventor's specific situation
- **IP Status Tracker** — the living document tracking all filed and pending IP assets, their current status, and key upcoming deadlines

---

## Documents Created

- **IP Brief** — the attorney briefing document; prepared before the first attorney meeting
- **IP Status Tracker** — the living record of all IP assets; updated as filings progress through all remaining stages
- **Trade Secret Log** — formal documentation of what constitutes protectable confidential information
- **NDA Template** — the standard agreement used with all third parties who receive access to confidential information
...
- The IP Brief has not been drafted
- No IP protection action has been initiated
- Third parties have had access to the invention without NDAs in place

**Getting There:**
- IP attorney has been contacted and a meeting is scheduled
- IP Brief is drafted but not yet delivered to the attorney
- At least one IP protection action is being prepared but has not yet been filed
- NDA coverage for most third parties is in place but some gaps remain
...
- All third parties with access to confidential information have signed NDAs
...
- IP attorney has been formally engaged
- IP Brief has been prepared and delivered to the attorney
- At least one IP protection action has been initiated — provisional filing, utility filing, trademark application, or formal trade secret documentation
- IP Status Tracker reflects the current status of all IP assets
- All relevant third parties — manufacturers, collaborators, contractors — have signed NDAs
- IP Filing Checklist is complete
...
The following information moves from Stage 9 forward to all remaining stages:

- **IP Status Tracker** — becomes a standing reference document for all subsequent stages; every marketing material, packaging element, and sales conversation must represent IP status accurately (e.g., "Patent Pending")
- **Trademark registration status** — feeds Stage 11 (Marketing) for brand protection guidance in all customer-facing materials
- **IP Brief and attorney relationship** — live assets relied on through Stage 13 (Funding), where IP status is a direct input to investor due diligence
- **NDA coverage record** — confirms that all manufacturer and partner relationships are protected; relevant to Stage 14 (Launch) for any new third-party engagements
- **Patent pending status** — a marketing asset in its own right; referenced in Stage 11 (Marketing) and Stage 14 (Launch) materials

The IP Status Tracker is a living document. It does not conclude at this stage — it is updated each time a new filing is made, a status changes, or a deadline approaches.
