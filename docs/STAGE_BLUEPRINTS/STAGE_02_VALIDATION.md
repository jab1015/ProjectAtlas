...
- Confirm that the problem they identified is experienced by real people, not just themselves
- Understand how acutely the target market feels the problem and what they do about it today
- Test whether the proposed solution concept resonates — or whether it needs to change
- Build a structured picture of the competitive landscape
- Arrive at a documented, honest go/no-go decision they can stand behind
...
- Validation evidence quality — the strength of each piece of evidence gathered

---

## Inputs

- Idea Brief from Stage 1 (problem statement, proposed solution, target audience)
- Customer research the inventor has already conducted (interviews, surveys, community observations)
- Competing products or alternatives the inventor has identified
- The inventor's assumptions about the market — who the customer is, how many of them exist, and how often they experience the problem
- Any community discussions, forums, or online complaints the inventor has observed related to the problem
...
- Assumption extraction from the Idea Brief — identifying the five highest-risk bets embedded in the concept
- Validation method recommendation tailored to each assumption
- Customer interview question generation for the specific audience and problem
- Interview and survey response analysis — pattern identification and signal quality assessment
- Competitive landscape research and side-by-side comparison drafting
- Validation theater detection — flagging low-quality evidence and redirecting toward stronger sources
- Problem-Market Fit evaluation based on validation data provided
- Go/no-go recommendation synthesis with documented reasoning
...
- The problem has not been confirmed by anyone outside the inventor's immediate circle
- No competitive alternatives have been analyzed
- The inventor has not documented their assumptions or assessed which ones are still open
- The Validation Report has not been drafted or reviewed

**Getting There:**
- 5 or more interviews completed with qualified subjects, but the findings are mixed or inconclusive
- Some competitive alternatives analyzed but the comparison is incomplete
- The top assumptions have been addressed but one or more remain unresolved
- Validation Report is drafted but not yet reviewed and confirmed by the inventor

**Ready to Move Forward:**
- At least 5 structured interviews completed with people who match the target audience and are not friends or family without relevant experience
- The problem is confirmed as real and significant by a meaningful portion of interview subjects
- At least 3 competitive alternatives have been analyzed
- The top 3 assumptions have been addressed with documented evidence
- Validation Report is finalized and reviewed by the inventor
- A documented go/no-go decision has been made

---

## Completion Criteria

- At least 5 customer interviews completed with people who match the target audience profile — not friends or family without genuine experience of the problem
- The problem has been confirmed as real and significant by interview evidence
- At least 3 competing alternatives have been analyzed in the Competitive Landscape
- The top 3 assumptions from the Assumption Risk Map have been addressed with documented evidence
- Validation Report is finalized and confirmed by the inventor
- A go/no-go decision has been made and recorded — including an explicit acknowledgment of risk if the inventor proceeds with insufficient evidence

---

## Handoff

The following information moves from Stage 2 into Stage 3 (Market Research):

- **Validation Report** — the confirmed problem statement and target audience definition from this report become the foundation of market sizing
- **Competitive Landscape** — carries forward directly; Stage 3 expands it with quantitative market share data
- **Assumption Risk Map** — the unvalidated or partially validated assumptions become the first research questions in Stage 3
- **Problem severity and willingness-to-pay signals** — from interviews; directly seeds the Stage 3 customer segment profiling and market sizing work
- **Go/No-Go Decision Record** — committed to the invention record as a milestone; confirms the inventor proceeded intentionally
- **Known competitors** — the starting list for Stage 3's competitive market share analysis

No validation findings are discarded. All interview synthesis, competitive observations, and assumption evidence carry forward as living context.
